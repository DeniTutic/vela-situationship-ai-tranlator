...
Base everything on the actual messages in this conversation. Be specific, honest, and constructive.`
      ...
      const debriefResponse = debrieces[0].message.content
    ...
    if (chat.isPractice) {
      ...
      systemPrompt = `You are roleplaying as "${chat.practiceTarget}" in a practiceonversation. 
...
Just respond as ${chat.practiceTarget} would.`
      ...
      const lengthInstruction = {
        ...
        plus: 'Keep responses MEDIUM length — a few sentences to a short paragraph. Be warm, clear, and helpful.',
        pro: 'Give DETAILED, thorough responses. Include deeper analysis, patterns, red flags, and actionable advice.'
      }
